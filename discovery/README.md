...
A Docker image containing an etcd daemon, for use in the [Deis](http://deis.io) open source PaaS.

[![image](https://d207aa93qlcgug.cloudfront.net/img/icons/framed-icon-checked-repository.svg)](https://index.docker.io/u/deis/discovery/)

[**Trusted Build**](https://index.docker.io/u/deis/discovery/)
